package com.nomme.creative.interfacess;
...
public interface Consts {
    ...
    //new 677440
    String BASE_URL = "http://creative.unindra.ac.id/Webservice/";
    String PAYMENT_FAIL = "http://creative.unindra.ac.id/Stripe/Payment/fail";
    String PAYMENT_SUCCESS = "http://creative.unindra.ac.id/Stripe/Payment/success";
    String MAKE_PAYMENT = "http://creative.unindra.ac.id/Stripe/Payment/make_payment/";

    String PAYMENT_FAIL_Paypal = "http://creative.unindra.ac.id/Webservice/payufailure";
    String PAYMENT_SUCCESS_paypal = "http://creative.unindra.ac.id/Webservice/payusuccess";
    String MAKE_PAYMENT_paypal = "http://creative.unindra.ac.id/Webservice/paypalWallent?";

    String INVOICE_PAYMENT_FAIL_Stripe = "http://creative.unindra.ac.id/Stripe/BookingPayement/fail";
    String INVOICE_PAYMENT_SUCCESS_Stripe = "http://creative.unindra.ac.id/Stripe/BookingPayement/success";
    String INVOICE_PAYMENT_Stripe = "http://creative.unindra.ac.id/Stripe/BookingPayement/make_payment/";

    String INVOICE__PAYMENT_paypal = "http://creative.unindra.ac.id/Webservice/paypal?";
    String PRIVACY_URL = "http://creative.unindra.ac.id/Webservice/privacy";
    String TERMS_URL = "http://creative.unindra.ac.id/Webservice/term";
