...
import com.nomme.creative.databinding.ActivityAddMoneyBinding;
import com.nomme.creative.databinding.DailogPaymentOptionBinding;
...
import com.nomme.creative.utils.DecimalDigitsInputFilter;
...
public class AddMoney extends AppCompatActivity implements View.OnClickListener {
    ...
    public void setUiAction() {
        ...
        binding.tv1000.setText("+ " + currency + " 5000");
        binding.tv1500.setText("+ " + currency + " 10000");
        binding.tv2000.setText("+ " + currency + " 20000");
